 ...
 * implement this interface and set it with {@link com.blakequ.blelibrary.logging.LogManager#setLogLevel(LogManager.LogLevel)}.
 *
 * @author Andrew Reitz
 * @see com.blakequ.blelibrary.logging.LogManager
 * @since 2.2
 */
