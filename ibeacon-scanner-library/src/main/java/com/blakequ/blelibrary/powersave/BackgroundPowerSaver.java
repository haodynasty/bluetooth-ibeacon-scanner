package com.blakequ.blelibrary.powersave;
...
public class BackgroundPowerSaver implements Application.ActivityLifecycleCallbacks {
    ...
    public BackgroundPowerSaver(Context context) {
        ...
        scanManager = ScanManager.getInstance(context);
    }
     ...
     * cycle starts), call {@link com.blakequ.blelibrary.ScanManager#updateScanPeriods}
     *
     * @param p
     */
